...
class Lexer:
    ...
    def __new_token(self, tt: TokenType, literal: Any) -> Token:
        ...
        return Token(type=tt, literal=literal, line_no=self.line_no, position=self.position) # type: ignore
    ...
    def __read_number(self) -> Token:
        ...
        output: str = ""
        while self.__is_digit(self.current_char) or self.current_char == '.': # type: ignore
            if self.current_char == '.':
                dot_count += 1
    ...
    def next_token(self) -> Token:
        ...
        match self.current_char:
            ...
            case '-':
                ...
                else: tok = self.__new_token(TokenType.MINUS, self.current_char)
            case '*':
